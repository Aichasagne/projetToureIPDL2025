// Components/student/Dashboard.jsx - Tableau de bord étudiant
            ...
            <Box sx={{ mb: 2 }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center' }}>
                <Box sx={{ width: '100%', mr: 1 }}>
                  <LinearProgress 
                    variant="determinate" 
                    value={displayData.validationStatus.progress} 
                    sx={{ height: 10, borderRadius: 5 }}
                  />
                </Box>
                <Box sx={{ minWidth: 35 }}>
                  <Typography variant="body2" color="text.secondary">
                    {`${displayData.validationStatus.progress}%`}
                  </Typography>
                </Box>
              </Box>
              <Typography variant="body2" sx={{ mt: 1 }}>
                {displayData.validationStatus.completedSteps} sur {displayData.validationStatus.totalSteps} étapes complétées
              </Typography>
            </Box>
            <Button 
              variant="contained" 
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              <Card variant="outlined">
                <CardContent>
                  ...
                  <Chip 
                    label={displayData.validationStatus.status === 'COMPLETED' ? 'Disponible' : 'En attente'} 
                    color={displayData.validationStatus.status === 'COMPLETED' ? 'success' : 'warning'}
                    size="small"
                    sx={{ mt: 1 }}
                  />
                </CardContent>
                <CardActions>
                  <Button 
                    ...
                    disabled={displayData.validationStatus.status !== 'COMPLETED'}
